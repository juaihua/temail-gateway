...
public class DisconnectHandler extends BaseHandler {
  ...
  public void process() {
    ...
    HttpEntity<CDTPPackage> requestEntity =
        new HttpEntity<CDTPPackage>(getCdtpPackage(), requestHeaders);
    AsyncRestTemplate asyncRt = new AsyncRestTemplate();

    ListenableFuture<ResponseEntity<String>> future =
        asyncRt
            .postForEntity(getTemailServerConfig().getDispatchUrl(), requestEntity, String.class);
