...
public class OnlineTemailManager {
  ...
  // 在线temail管理
  private static Map<String, TemailInfo> onlineTemailMap =
      new ConcurrentHashMap<String, TemailInfo>();

  // socketChannel 对应多个Temail
  private static Map<String, List<TemailInfo>> activeChannelMap =
      new ConcurrentHashMap<String, List<TemailInfo>>();
